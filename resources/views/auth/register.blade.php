        ...
        <div class="login-container">
            <div class="login-wrapper">
                ...
                <div class="login-form">
                    ...
                    {!! Form::open(['url'=>route('admin.register'),'class'=>'form-wrapper']) !!}
                    ...
                    <div class="input-wrapper">
                        ...
                        <div class="input-wrapper">
                            ...
                            {!! Form::text('email',old('email'),['class'=>'input-field','placeholder'=>'Enter email','data-validation'=>'required']) !!}
                            @if($errors->has('email'))
                        ...
                        <div class="additional-info">
                            <div class="checkbox-wrapper">
                                ...
                                <span class="checkbox-label">I accept all terms and condition</span>
                            </div>
                        </div>

                        <button class="btn btn--primary login-btn">Register now</button>
                        <div class="text">
